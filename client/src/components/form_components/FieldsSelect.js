...
export default ({ entities, select, input, label, name, meta: { error, touched } }) => { // { input } analgous to props.input (contains all the callback functions)
  if(label === 'Entity') {
    selectOptions = entities.map((entity) => {
